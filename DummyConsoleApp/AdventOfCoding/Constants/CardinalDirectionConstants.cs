namespace DummyConsoleApp.AdventOfCoding.Constants
{
    ...
    {
        public static Dictionary<CardinalDirection, List<CardinalDirection>> LeftOrdering =
            new Dictionary<CardinalDirection, List<CardinalDirection>>()
            {
                {
        ...
        public static Dictionary<CardinalDirection, CardinalDirection> InvertDirection =
