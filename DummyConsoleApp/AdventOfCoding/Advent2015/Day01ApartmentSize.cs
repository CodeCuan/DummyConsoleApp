...
public class Day01ApartmentSize
{
    public void Main()
    {
        ...
        stoppy.Stop();
        Console.WriteLine(
            $"Day 1 Apartment Size: {floorSize} (Execution Time: {stoppy.ElapsedMilliseconds} ms)"
        );
        Console.WriteLine(
            $"Day 1 Basement Entry Position: {basementEntry} (Execution Time: {stoppy.ElapsedMilliseconds} ms)"
        );
    }
